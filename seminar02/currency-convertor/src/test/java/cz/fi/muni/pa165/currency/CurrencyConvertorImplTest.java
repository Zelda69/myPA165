...
public class CurrencyConvertorImplTest {
    ...
    public void testConvert() {
        ...
        softly.assertThat(convertor.convert(source, target, new BigDecimal("10.050"))).isEqualTo(new BigDecimal("1.00"));
        softly.assertThat(convertor.convert(source, target, new BigDecimal("10.051"))).isEqualTo(new BigDecimal("1.01"));
        softly.assertThat(convertor.convert(source, target, new BigDecimal("10.150"))).isEqualTo(new BigDecimal("1.02"));
